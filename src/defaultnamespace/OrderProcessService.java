 ...
 * 
 */
@WebServiceClient(name = "OrderProcessService", targetNamespace = "http://DefaultNamespace", wsdlLocation = "http://localhost:8080/OrderWebServiceSOAP/services/OrderProcess?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERPROCESSSERVICE_QNAME = new QName("http://DefaultNamespace", "OrderProcessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/OrderWebServiceSOAP/services/OrderProcess?wsdl");
     ...
     */
    @WebEndpoint(name = "OrderProcess")
    public OrderProcess getOrderProcess() {
        return super.getPort(new QName("http://DefaultNamespace", "OrderProcess"), OrderProcess.class);
    }
     ...
     */
    @WebEndpoint(name = "OrderProcess")
    public OrderProcess getOrderProcess(WebServiceFeature... features) {
        return super.getPort(new QName("http://DefaultNamespace", "OrderProcess"), OrderProcess.class, features);
    }
